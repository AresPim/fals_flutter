//import 'models/detailpost_settings_model.dart';
...
import 'provider/detailpost_settings_provider.dart';

class DetailpostSettingsScreen extends StatefulWidget {
  const DetailpostSettingsScreen({Key? key}) : super(key: key);

  @override
  DetailpostSettingsScreenState createState() =>
      DetailpostSettingsScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DetailpostSettingsProvider(),
        child: DetailpostSettingsScreen());
  }
}

// ignore_for_file: must_be_immutable
class DetailpostSettingsScreenState extends State<DetailpostSettingsScreen> {
